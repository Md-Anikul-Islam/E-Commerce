	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="index.html"><span>Online Shopping Admin</span></a>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="{{URL::to('/add-category')}}"><i class="icon-edit"></i><span class="hidden-tablet">Add Category</span></a></li>
						
						<li><a href="{{URL::to('/all-brands')}}"><i class="icon-eye-open"></i><span class="hidden-tablet">All Brands</span></a></li>

						<li><a href="{{URL::to('/add-brands')}}"><i class="icon-edit"></i><span class="hidden-tablet">Add Brands</span></a></li>
						<li>
							...
							<ul>
								<li><a class="submenu" href="{{URL::to('/add-products')}}"><i class="icon-edit"></i><span class="hidden-tablet">Add Products</span></a></li>
								<li><a class="submenu" href="{{URL::to('/all-products')}}"><i class="icon-eye-open"></i><span class="hidden-tablet">All Products</span></a></li>
